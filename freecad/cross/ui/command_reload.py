...
class _ReloadCommand:
    ...
    def Activated(self):
        ...
        _reload_module('freecad.cross.ik')
        _reload_module('freecad.cross.ik_utils')
        _reload_module('freecad.cross.import_dae')
        _reload_module('freecad.cross.joint')
        _reload_module('freecad.cross.joint_proxy')
        _reload_module('freecad.cross.lidar2d')
        _reload_module('freecad.cross.lidar2d_proxy')
        _reload_module('freecad.cross.link')
        _reload_module('freecad.cross.link_proxy')
        _reload_module('freecad.cross.mesh_utils')
        _reload_module('freecad.cross.observer')
        _reload_module('freecad.cross.observer_proxy')
        ...
        _reload_module('freecad.cross.rgb_camera')
        _reload_module('freecad.cross.rgb_camera_proxy')
        _reload_module('freecad.cross.robot')
        _reload_module('freecad.cross.robot_from_kk')
        _reload_module('freecad.cross.robot_from_topic')
        ...
        _reload_module('freecad.cross.ros.robot_description')
        _reload_module('freecad.cross.ros.utils')
        _reload_module('freecad.cross.solver_wrappers.pinocchio')
        _reload_module('freecad.cross.solver_wrappers.robotpkg')
        ...
        _reload_module('freecad.cross.ui.command_duplicate_robot')
        ...
        _reload_module('freecad.cross.ui.command_new_observer')
        _reload_module('freecad.cross.ui.command_new_pose')
        _reload_module('freecad.cross.ui.command_new_rgb_camera')
        ...
        _reload_module('freecad.cross.ui.robot_description_topic_dialog')
