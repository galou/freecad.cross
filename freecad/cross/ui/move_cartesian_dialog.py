...
class MoveCartesianDialog(QtGui.QDialog):
    ...
    def _set_up_gui(self) -> None:
        ...
        self.form.linear_step_combo_box.clear()
        for value in self.LINEAR_STEP_VALUES:
            self.form.linear_step_combo_box.addItem(f'{value:g}')
        self.form.linear_step_combo_box.setCurrentIndex(
            self.LINEAR_STEP_VALUES.index(10.0),
        )

        self.form.angular_step_combo_box.clear()
        for value in self.ANGULAR_STEP_VALUES:
            self.form.angular_step_combo_box.addItem(f'{value:g}')
        self.form.angular_step_combo_box.setCurrentIndex(
            self.ANGULAR_STEP_VALUES.index(10.0),
        )
    ...
    def _sync_linear_step(self) -> None:
        self.form.linear_step_spin_box.setValue(
            float(self.form.linear_step_combo_box.currentText()),
        )

    def _sync_angular_step(self) -> None:
        self.form.angular_step_spin_box.setValue(
            float(self.form.angular_step_combo_box.currentText()),
        )
