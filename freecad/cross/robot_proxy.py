...
CrossLink = Link  # A Cross::Link, i.e. a DocumentObject with Proxy "Link".
CrossJoint = Joint  # A Cross::Joint, i.e. a DocumentObject with Proxy "Joint".
CrossRobot = Robot  # A Cross::Robot, i.e. a DocumentObject with Proxy "Robot".
